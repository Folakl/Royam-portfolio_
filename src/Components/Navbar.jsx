...
const Navbar = ({ togglemenu, setTogglemenu, skillRef, aboutRef, projectRef,servicesRef, homeRef, TopRef}) => {
 const scrolltoHome =()=>{
 ...
 const scrolltoproject = ()=>{
  ...
  return (
    <div ref={TopRef}>
      {/* Top Navbar */}
      <div className='font-bold text-white  text-[10px] items-center h-contain flex justify-between pl-10 pr-2 pt-5 pb-2'>
        <div>
        ...
        <div>
          <button className='bg-purple-900  border-purple-500 border-2 outline-none w-[120px] h-[30px] hover:w-[130px] hover:h-[32px] rounded-full text-white lg:block md:block hidden'>
